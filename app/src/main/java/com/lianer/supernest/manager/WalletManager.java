...
public class WalletManager {
     ...
     * @return wallet 钱包
     */
    public WalletBean generateWallet(
            String password,
            String mnemonics) throws CipherException {
        ECKeyPair keyPair = generateKeyPair(mnemonics);
        return new WalletBean(Wallet.createLight(password, keyPair));
    }
